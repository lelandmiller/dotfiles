...
color03="d3/b9/87" # Base 0A - Yellow
color04="44/77/8d" # Base 0D - Blue
color05="b3/de/ef" # Base 0E - Magenta
color06="33/52/61" # Base 0C - Cyan
...
color16="79/31/3c" # Base 09
color17="71/5b/2f" # Base 0F
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg bbbbbb # foreground
